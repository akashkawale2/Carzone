    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('MU', 'Mumbai'), ('DE', 'Delhi'), ('PU', 'Pune'), ('BA', 'Banglore'), ('HY', 'Hyderabad'), ('AH', 'Ahmedabad'), ('CH', 'Chennai'), ('KO', 'Kolkata'), ('SU', 'Surat'), ('JA', 'Jaipur'), ('LA', 'Lucknow'), ('KA', 'Kanpur'), ('NA', 'Nagpur'), ('IN', 'Indore'), ('TH', 'Thane'), ('BH', 'Bhopal'), ('VI', 'Vishakapatnam'), ('PA', 'Patna'), ('VA', 'Vadodara'), ('GH', 'Ghaziabad'), ('LU', 'Ludhiana'), ('AG', 'Agra'), ('NA', 'Nashik'), ('FA', 'Faridabad'), ('ME', 'Meerut'), ('RA', 'Rajkot'), ('VA', 'Varanasi'), ('SR', 'Srinagar'), ('AU', 'Aurangabad'), ('DH', 'Dhanbad'), ('NM', 'Navi Mumbai'), ('AM', 'Amritsar'), ('AL', 'Allahabad'), ('RA', 'Ranchi'), ('CO', 'Coimbatore'), ('JA', 'Jabalpur'), ('GW', 'Gwalior'), ('VI', 'Vijayawada'), ('JO', 'Jodhpur'), ('MA', 'Madurai'), ('RA', 'Raipur'), ('KO', 'Kota'), ('GU', 'Guwahati'), ('TI', 'Tiruchirappalli'), ('BH', 'Bhubaneswar'), ('BI', 'Bikaner'), ('WA', 'Warangal'), ('KO', 'Kochi'), ('JA', 'Jammu'), ('MA', 'Mangalore')], max_length=100)),
